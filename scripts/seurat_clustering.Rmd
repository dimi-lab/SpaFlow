...
globals_maxsize_MB <- as.numeric(configs$value[configs$object == "globals_maxsize_MB"])
...
# Set maximumn size for globals in future package
options(future.globals.maxSize = globals_maxsize_MB * 1024^2)
```
