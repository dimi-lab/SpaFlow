...
```{r results='asis'}
cat(paste0('<img src="', "optimal_cluster_", roi, ".png", '" width="94%"/><br>')) #### Make all plots larger in report
```

## Image plot of clusters: K-means
```{r results='asis'}
cat(paste0('<img src="', "show_kmeans_", roi, ".png", '" width="700"/><br>'))
```

## UMAP of clusters: K-means
```{r results='asis'}
cat(paste0('<img src="', "umap_kmeans_", roi, ".png", '" width="600"/><br>')) #### Make all plots larger in report
```

## Heatmap of clusters: K-means
```{r results='asis'}
cat(paste0('<img src="', "matrixplot_kmeans_", roi, ".png", ' width="94%"/><br>'))
```
